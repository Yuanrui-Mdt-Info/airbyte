...
public class ZohoDeskOAuthFlow extends BaseOAuth2Flow {
  ...
  @Override
  public SourceEntityRead getSourceEntity(UUID workspaceId, UUID sourceDefinitionId, String oauthStateSecret, Map<String, Object> params)
      throws IOException, ConfigNotFoundException {
    return super.getSourceEntity(workspaceId, sourceDefinitionId, oauthStateSecret, params);
  }
