...
class FromDictMixin:
    ...
    #     required_fields = cls._field_names()
    #     import pdb;pdb.set_trace()

    #     filtered_dict = {key: val for key, val in dct.items() if key in required_fields}
    #     # filtered_dict = {key: val for key, val in dct.items() }
    #     for field in required_fields:
    #         import pdb;pdb.set_trace()
    #         if field not in filtered_dict:
    #             filtered_dict[field] = None  # Or provide a sensible default value
    ...
    #         # 'modifier':'modifier'
    #     }
    #     mapped_dct = {field_mapping.get(key, key): val for key, val in dct.items()}
    #     mapped_dct['api_supported'] = True
    #     return cls(**cls._filter_by_names(mapped_dct))
...
class FieldMeta(FromDictMixin):
    ...
    def from_dict(cls, dct: MutableMapping[Any, Any]) -> object:
        ...
        filtered_dct = {key: val for key, val in dct.items() if key in field_names}
