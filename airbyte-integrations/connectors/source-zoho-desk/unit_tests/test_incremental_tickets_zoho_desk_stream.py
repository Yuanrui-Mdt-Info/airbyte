...
from source_zoho_desk.streams import IncrementalTicketsZohoDeskStream
...
def stream(mock_zoho_api):
    ...
    return IncrementalTicketsZohoDeskStream(config=MOCK_CONFIG)
