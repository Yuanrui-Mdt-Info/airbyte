...
from source_zoho_desk.streams import IncrementalAccountsZohoDeskStream
...
def stream(mock_zoho_api):
    ...
    return IncrementalAccountsZohoDeskStream(config=MOCK_CONFIG)
