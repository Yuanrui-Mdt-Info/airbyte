...
from source_zoho_desk.streams import IncrementalAgentsZohoDeskStream
...
def stream(mock_zoho_api):
    ...
    return IncrementalAgentsZohoDeskStream(config=MOCK_CONFIG)
